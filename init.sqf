...
// dyn_standart_combat_vehicles = ["O_T_APC_Wheeled_02_rcws_v2_F", "O_T_MRAP_02_hmg_F", "O_T_APC_Tracked_02_cannon_F"];
// dyn_standart_mechs = ["O_T_APC_Wheeled_02_rcws_v2_F", "O_T_APC_Tracked_02_cannon_F"]; //"cwr3_O_T_mtlb_pk"
// dyn_standart_light_armed_transport = ["O_T_LSV_02_armed_F", "O_T_LSV_02_unarmed_F", "O_T_LSV_02_AT_F"];
// dyn_standart_tanks = ["O_T_APC_Tracked_02_cannon_F", "O_T_MBT_04_cannon_F"];
...
// dyn_standart_light_amored_vic = "O_T_MRAP_02_hmg_F";
